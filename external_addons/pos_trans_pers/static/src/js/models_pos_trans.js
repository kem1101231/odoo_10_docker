odoo.define('pos_trans_pers.models_pos_trans', function (require) {
"use strict";

var BarcodeParser = require('barcodes.BarcodeParser');
var PosDB = require('pos_trans_pers.db_pos_trans');
var devices = require('pos_trans_pers.devices_pos_trans');
...
exports.PosModel = Backbone.Model.extend({
    initialize: function(session, attributes) {
        ...
        custom_model.call('posExtDisData');
        ...
        function update_mechan() {
            var order = self.get_order();
            this.set('selectedMecha', order ? order.get_mechan() : null );
        }
        this.get('orders').bind('add remove change', update_client, this);
        this.bind('change:selectedOrder', update_client, this);

        this.get('orders').bind('add remove change', update_mechan, this);
        this.bind('change:selectedOrder', update_mechan, this);
    ...
    set_mech_sel_id: function(inputData){
        mech_sel_id = inputData
       // custom_model.call('setPosExtMechData',{'datain': inputData['id']})
    },

    get_mecha1: function() {
        return mech_sel_id;
    },
    set_omec_sel_id: function(inputData){
        omec_sel_id = inputData
       // custom_model.call('setPosExtMechData',{'datain': inputData['id']})
    },
    ...
    set_chkr_sel_id: function(inputData){
        chkr_sel_id = inputData
        //custom_model.call('setPosExtChckrData', {'datain': inputData['id']})
    },

    get_chckr: function() {
        return chkr_sel_id;
    },
    set_pckr_sel_id: function(inputData){
        pckr_sel_id = inputData
        //custom_model.call('setPosExtPackrData', {'datain': inputData['id']})
    },
    ...
    push_order: function(order, opts) {
        ...
        if(order){
            ...
            console.log("please be here")
            //custom_model.call('addDatatoDB')

            console.log("Dito na sana")
            custom_model.call('get_pos_trans_data', {'ord_id': 3})
        }
...
exports.Order = Backbone.Model.extend({
    ...
    get_mecha_name: function(){
        var mecha = mech_sel_id;
        return mecha['name'];
    },

    get_omec_name: function(){
        var omech = omec_sel_id;
        return omech['name'];
    },
    set_chckr: function(client){
        //this.assert_editable();
        //this.set('client',client);
    },
    get_chckr: function(){
    ...
    get_chckr_name: function(){
        var chckr = chkr_sel_id;
        return chckr['name'];
    },

    set_packr: function(client){
        //this.assert_editable();
        //this.set('client',client);
    },
    get_packr: function(){
    ...
    get_packr_name: function(){
        var packr = pckr_sel_id;
        return packr['name'];
    },
    /* ---- Screen Status --- */
